...
$group_names = [System.Collections.ArrayList](Get-Content "$basePath\data\group_names.txt")
$first_names = [System.Collections.ArrayList](Get-Content "$basePath\data\first_name.txt")
$last_names  = [System.Collections.ArrayList](Get-Content "$basePath\data\last_name.txt")
$passwords   = [System.Collections.ArrayList](Get-Content "$basePath\data\passwords.txt")
<#
$groups = @()
$num_groups = 10 
